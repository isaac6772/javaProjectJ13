...
<body>
	...
	<div class = "container">
		<form class = "boardContainer" name = "boardForm" method = "post" action = "informWriteOk.ad" enctype = "multipart/form-data" >
			<div class = "part">
				<span>공지사항</span>
				<i class="fa-solid fa-volume-high fa-xl" style = "left : 100px"></i>
			</div>
			<div class = "table">
				<div class = "tr">
					<div class = "td">
				...
				<div class = "tr">
					...
					<div class = "td" style = "width : 50%; text-align: right; float : right;">
						<input type = "button" class = "boardWrite" onclick = "informWrite()" value = "등 록" />
					</div>
				</div>
