...
public class BoardInformListCommand implements BoardInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totRecCnt = dao.getInformRecCnt();
		...
		ArrayList<BoardVO> vos = dao.getBoardList(startIndexNo, pageSize, "공지");
